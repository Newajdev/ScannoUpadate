...
export default function SocialIcon({ isArabic }) {
  return (
    <div className="">
      <div
        className={`fixed top-[15%] lg:top-[50%] -translate-y-1/2 left-1/2 -translate-x-1/2  ${
          isArabic ? "lg:left-[90%] xl:left-[80%]  " : "lg:left-28 xl:left-60 "
        } text-white flex flex-col lg:flex-row items-center gap-3 lg:gap-6 rotate-0 lg:-rotate-90 lg:w-[320px]`}
      >
